...
CONTROL ROOM replaces Chilkey's broken official "web driver" with a proper cross-platform tool. It remaps keys, controls RGB, uploads images to the LCD, and turns the screen into a live widget surface for clock, weather, Now Playing, and more.
